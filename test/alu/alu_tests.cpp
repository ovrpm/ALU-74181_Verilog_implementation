...
bool test_logic(Valu* dut){
    ...
    for (int i = 0; i < 1000; i++){
	    ...
	    //dut->sel = 0;
        if (i < 63) dut->sel = 0; 			//0
        else if (i < 127 ) dut->sel = 1;
	else if (i < 190) dut->sel = 2;
        else if (i < 254) dut->sel = 3;
        else if (i < 317) dut->sel = 4;
        else if (i < 381) dut->sel = 5;
        else if (i < 444) dut->sel = 6;
        else if (i < 508) dut->sel = 7;
        else if (i < 571) dut->sel = 8;
        else if (i < 645) dut->sel = 9;
        else if (i < 708) dut->sel = 10;
        else if (i < 772) dut->sel = 11;
        else if (i < 835) dut->sel = 12;
        else if (i < 899) dut->sel = 13;
        else if (i < 962) dut->sel = 14;
	    else dut->sel = 15;
...
bool test_arithmetic_2(Valu* dut){
	...
	if (expected_output == dut_output){
		...
		std::cout << "a = " << rand_a << " b = " << rand_b << " alu = " << dut_output << " cpp = " << expected_output << std::endl;
		return false;
	}
    }
    return true;
...
bool test_arithmetic_5(Valu* dut){
	...
	if (expected_output == dut_output && expected_cout == dut_cout){
		...
		std::cout << "a = " << rand_a << " b = " << rand_b << " cin = " << rand_cin << " alu = " << dut_output << " cpp = " << expected_output << std::endl;
		return false;
	}
    }
    return true;
...
bool test_arithmetic_6(Valu* dut){
	...
	if (expected_output < 0) expected_output += 65536;
	int expected_cout;
	if (rand_a - rand_b - 1 + rand_cin >= 65536) expected_cout = 1;
	else expected_cout = 0;
	int dut_output = (int)dut->alu_out;
	int dut_cout = (int)dut->carry_out;
...
bool test_arithmetic_7(Valu* dut){
	...
	if (expected_output < 0) expected_output += 65536;
	int expected_cout;
	if ((rand_a & (65535 - rand_b)) - 1 + rand_cin >= 65536) expected_cout = 1;
	else if (((rand_a & (65535 - rand_b)) - 1 + rand_cin == 0) && (rand_cin == 1)) expected_cout = 1;
	else expected_cout = 0;
...
bool test_arithmetic_8(Valu* dut){
	...
	if (expected_output < 0) expected_output += 65536;
	int expected_cout;
	if (rand_a + (rand_a & rand_b) + rand_cin >= 65536) expected_cout = 1;
	else expected_cout = 0;
...
bool test_arithmetic_9(Valu* dut){
	...
	if (expected_output < 0) expected_output += 65536;
	int expected_cout;
	if (rand_a + rand_b + rand_cin >= 65536) expected_cout = 1;
	else expected_cout = 0;
...
bool test_arithmetic_10(Valu* dut){
	...
	int expected_cout;
	if (((rand_a | (65535 - rand_b)) + (rand_a & rand_b) + rand_cin) >= 65536) expected_cout = 1;
	else expected_cout = 0;
...
bool test_arithmetic_11(Valu* dut){
	...
	int expected_cout;
	if (((rand_a & rand_b) - 1 + rand_cin) >= 65536) expected_cout = 1;
	else if (((rand_a & rand_b) - 1 + rand_cin == 0) && (rand_cin == 1)) expected_cout = 1;
	else expected_cout = 0;
...
bool test_arithmetic_12(Valu* dut){
	...
	int expected_cout;
	if ((rand_a + rand_a + rand_cin) >= 65536) expected_cout = 1;
	else expected_cout = 0;
...
bool test_arithmetic_13(Valu* dut){
	...
	int expected_cout;
	if (((rand_a | rand_b) + rand_a + rand_cin) >= 65536) expected_cout = 1;
	else expected_cout = 0;
...
bool test_arithmetic_14(Valu* dut){
	...
	int expected_cout;
	if (((rand_a | (65535 - rand_b)) + rand_a + rand_cin) >= 65536) expected_cout = 1;
	else expected_cout = 0;
...
bool test_arithmetic_15(Valu* dut){
	...
	if (expected_output < 0) expected_output += 65536; 
	int expected_cout;
	if ((rand_a - 1 + rand_cin) >= 65536) expected_cout = 1;
	else if ((rand_a - 1 + rand_cin == 0) && (rand_cin == 1)) expected_cout = 1;
	else expected_cout = 0;
